...
public class LettersUI extends Application {
	...
	public void start(Stage stage) {
		...
		Thread t1 = new Thread(new MyTask(o1, o2, (Text) hbox.getChildren().get(0), this));
		Thread t2 = new Thread(new MyTask(o2, o3, (Text) hbox.getChildren().get(1), this));
		Thread t3 = new Thread(new MyTask(o3, o1, (Text) hbox.getChildren().get(2), this));
		t1.setDaemon(true);
		t2.setDaemon(true);
		t3.setDaemon(true);
		t1.start();
...
//				}
	...
	class MyTask implements Runnable {
		...
		public MyTask(Object m, Object y, Text text, LettersUI zeroOROne) {
